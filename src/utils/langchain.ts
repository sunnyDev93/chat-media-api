...
const promptTemplate = PromptTemplate.fromTemplate(`Given the user question below, classify it as either being about \`LangChain\`, \`Anthropic\`, or \`Other\`.
...
const classificationChainResult = classificationChain.invoke({question: "how do I call Anthropic?"});
...
const langChainChain = PromptTemplate.fromTemplate(`You are an expert in langchain.
...
const anthropicChain = PromptTemplate.fromTemplate(`You are an expert in anthropic. \
